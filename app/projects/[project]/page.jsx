...
const ProjectDetailPage = () => {
	...
	return (
		<div className="mx-4 my-8 md:mx-auto max-w-3xl">
			...
			<div className="border-y-[1px] my-2 p-2 border-white/20  items-center justify-between gap-x-2 hidden md:flex">
				<ul className="flex gap-x-2">
					<li>
						<PiSpeakerSimpleNoneLight className="w-6 h-6" />
					</li>
				</ul>
				<ul className="flex gap-x-2">
					<li>
			...
			<div className="flex gap-x-2 items-center justify-between md:hidden my-3">
				<div className="flex gap-x-2 items-center">
					<button className="rounded-3xl py-1 px-3 border flex items-center gap-x-2 border-white/20">
						<PiSpeakerSimpleNoneLight className="w-5 h-5" />
			...
			<article className="my-10">
				...
				/>
				<section className="space-y-5 my-10 text-text-primary text-sm leading-6 md:text-base ">
					<p>
						nec feugiat in. Eu tincidunt tortor aliquam nulla
						facilisi. Amet mattis vulputate enim nulla aliquet.
						Augue eget arcu dictum varius duis. Amet porttitor eget
						dolor morbi. Quis varius quam quisque id diam vel quam.
						Est velit egestas dui id ornare arcu odio. Massa
						placerat duis ultricies lacus sed turpis tincidunt. At
						risus viverra adipiscing at in tellus integer feugiat.
						Mauris pharetra et ultrices neque ornare aenean euismod
						elementum nisi. Bibendum neque egestas congue quisque
						egestas diam. Adipiscing commodo elit at imperdiet dui
						accumsan sit. Montes nascetur ridiculus mus mauris.
						Vitae aliquet nec ullamcorper sit amet risus. Congue
						quisque egestas diam in arcu cursus. Malesuada bibendum
						arcu vitae elementum curabitur vitae nunc sed velit.
						Gravida cum sociis natoque penatibus et magnis dis
						parturient. Imperdiet dui accumsan sit amet. Scelerisque
						eleifend donec pretium vulputate sapien nec sagittis
						aliquam. Varius vel pharetra vel turpis nunc eget lorem
						dolor sed. Mauris commodo quis imperdiet massa tincidunt
						nunc pulvinar sapien. Egestas fringilla phasellus
						faucibus scelerisque eleifend donec pretium vulputate
						sapien. Morbi non arcu risus quis varius quam.
						Adipiscing elit pellentesque habitant morbi tristique
						senectus. Cursus eget nunc scelerisque viverra. Ipsum
					...
					<p>
						...
						different problems by giving examples. Overriding the
						call operator in a class, operator (), makes it possible
						to call an object like an ordinary function. Function
						objects (also known as functors) are
					</p>
					<p>
						In this blog post, I would like to explain what are
						function objects and how they can be used to solve
					...
					<p>
						...
						function objects and how they can be used to solve
						different problems by giving examples. Overriding the
						call operator in a class,
					</p>
					<p>
						operator. They are typically defined as classes in C++,
						so they also enjoy the features of classes. Using only
						classes and functions solves many problems and it is
						fine. But sometimes function objects are easier to use
						and save us from the burden of complex solutions. STL
						(Standard Template Library) in C++ provides useful
						built-in function obj/ects and makes things easier.
						Understanding how they are implemented under the hood
						gives insight and encourages us to write custom function
						objects
					</p>
					<p>
						if built-in function objects are not enough. The
						question is in which situations do we prefer functions
						objects? OK, lets go through the examples and see how we
						can use functions objects for the problems.
					</p>
				</section>
			</article>
		</div>
